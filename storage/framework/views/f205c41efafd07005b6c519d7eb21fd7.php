        ...
        <div x-data="{ sidebarOpen: false }" class="min-h-screen flex">
            ...
            <div class="relative">
                ...
                <div class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0"
                        ...
                        <div class="flex items-center">
                            ...
                            <?php if($logoPath): ?>
                                <img src="<?php echo e(asset('storage/' . $logoPath)); ?>" 
                                     ...
                                     class="h-8 w-auto">
                            <?php else: ?>
                                <span class="text-lg font-bold text-white"><?php echo e($systemName); ?></span>
                            <?php endif; ?>
                        </div>
                    ...
                    <!-- Navigation -->
                    <nav class="mt-8 px-4">
                        <?php echo $__env->make('layouts.sidebar-navigation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </nav>
                        ...
                        <div class="flex items-center space-x-3">
                            <?php if(Auth::user()->hasProfilePhoto()): ?>
                                <div class="w-10 h-10 rounded-full overflow-hidden border-2 border-gray-300 flex-shrink-0">
                                    <img src="<?php echo e(Auth::user()->getProfilePhotoUrl()); ?>" 
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500 truncate">
                                    <?php echo e(Auth::user()->role === 'admin' ? 'Administrador' : (Auth::user()->role === 'professor' ? 'Professor' : 'Aluno')); ?>
                ...
                <header class="bg-white shadow-sm border-b border-gray-200 lg:hidden">
                    <div class="flex items-center justify-between h-16 px-4">
                        ...
                        <span class="text-lg font-semibold text-gray-900">
                            <?php echo e($systemName ?? 'Sistema de Avaliacao'); ?>
...
</html><?php /**PATH C:\Users\villa\Desktop\laragon\www\sisInscricao\resources\views/layouts/app.blade.php ENDPATH**/ ?>