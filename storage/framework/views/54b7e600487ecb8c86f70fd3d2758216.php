...
<div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        <div class="p-6 sm:p-8">
            ...
            <form method="POST" action="<?php echo e($formAction); ?>" enctype="multipart/form-data" class="space-y-8">
                <?php echo csrf_field(); ?>
                <?php if($isEdit): ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                                Senha <?php echo e($isEdit ? '(deixe em branco para manter a atual)' : '*'); ?>
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-2">
                                Confirmar Senha <?php echo e($isEdit ? '(se alterando)' : '*'); ?>
                        ...
                        <div>
                            ...
                            <select name="role" id="role" 
                                ...
                                <option value="professor" <?php echo e(old('role', $user->role ?? '') == 'professor' ? 'selected' : ''); ?>>Professor</option>
                                <option value="aluno" <?php echo e(old('role', $user->role ?? '') == 'aluno' ? 'selected' : ''); ?>>Aluno</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <?php if($isEdit && $user->profile_photo): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e(asset('storage/' . $user->profile_photo)); ?>" alt="Foto atual" class="w-16 h-16 rounded-full object-cover">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="date" name="data_nascimento" id="data_nascimento" 
                                   value="<?php echo e(old('data_nascimento', $user->data_nascimento ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="idade" id="idade" min="1" max="120"
                                   value="<?php echo e(old('idade', $user->idade ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="sexo" id="sexo" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="">Selecione...</option>
                                <option value="masculino" <?php echo e(old('sexo', $user->sexo ?? '') == 'masculino' ? 'selected' : ''); ?>>Masculino</option>
                                <option value="feminino" <?php echo e(old('sexo', $user->sexo ?? '') == 'feminino' ? 'selected' : ''); ?>>Feminino</option>
                                <option value="outro" <?php echo e(old('sexo', $user->sexo ?? '') == 'outro' ? 'selected' : ''); ?>>Outro</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="rg" id="rg" 
                                   value="<?php echo e(old('rg', $user->rg ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="bf" id="bf" 
                                   value="<?php echo e(old('bf', $user->bf ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <select name="estado_civil" id="estado_civil" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="">Selecione...</option>
                                <option value="solteiro" <?php echo e(old('estado_civil', $user->estado_civil ?? '') == 'solteiro' ? 'selected' : ''); ?>>Solteiro</option>
                                <option value="casado" <?php echo e(old('estado_civil', $user->estado_civil ?? '') == 'casado' ? 'selected' : ''); ?>>Casado</option>
                                <option value="divorciado" <?php echo e(old('estado_civil', $user->estado_civil ?? '') == 'divorciado' ? 'selected' : ''); ?>>Divorciado</option>
                                <option value="viuvo" <?php echo e(old('estado_civil', $user->estado_civil ?? '') == 'viuvo' ? 'selected' : ''); ?>>Viúvo</option>
                                <option value="uniao_estavel" <?php echo e(old('estado_civil', $user->estado_civil ?? '') == 'uniao_estavel' ? 'selected' : ''); ?>>União Estável</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="tamanho_camisa" id="tamanho_camisa" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="">Selecione...</option>
                                <option value="PP" <?php echo e(old('tamanho_camisa', $user->tamanho_camisa ?? '') == 'PP' ? 'selected' : ''); ?>>PP</option>
                                <option value="P" <?php echo e(old('tamanho_camisa', $user->tamanho_camisa ?? '') == 'P' ? 'selected' : ''); ?>>P</option>
                                <option value="M" <?php echo e(old('tamanho_camisa', $user->tamanho_camisa ?? '') == 'M' ? 'selected' : ''); ?>>M</option>
                                <option value="G" <?php echo e(old('tamanho_camisa', $user->tamanho_camisa ?? '') == 'G' ? 'selected' : ''); ?>>G</option>
                                <option value="GG" <?php echo e(old('tamanho_camisa', $user->tamanho_camisa ?? '') == 'GG' ? 'selected' : ''); ?>>GG</option>
                                <option value="XG" <?php echo e(old('tamanho_camisa', $user->tamanho_camisa ?? '') == 'XG' ? 'selected' : ''); ?>>XG</option>
                                <option value="XXG" <?php echo e(old('tamanho_camisa', $user->tamanho_camisa ?? '') == 'XXG' ? 'selected' : ''); ?>>XXG</option>
                            </select>
                        </div>
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex items-center">
                                    ...
                                    <input type="checkbox" name="tem_filhos" id="tem_filhos" value="1" 
                                           <?php echo e(old('tem_filhos', $user->tem_filhos ?? false) ? 'checked' : ''); ?>

                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                    <label for="tem_filhos" class="ml-2 block text-sm text-gray-900">Tem filhos</label>
                                </div>
                                
                                <div id="quantidade_filhos_container" style="display: <?php echo e(old('tem_filhos', $user->tem_filhos ?? false) ? 'block' : 'none'); ?>;">
                                    ...
                                    <input type="number" name="quantidade_filhos" id="quantidade_filhos" min="0" max="20"
                                           value="<?php echo e(old('quantidade_filhos', $user->quantidade_filhos ?? '')); ?>" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="bairro" id="bairro" 
                                   value="<?php echo e(old('bairro', $user->bairro ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="cidade" id="cidade" 
                                   value="<?php echo e(old('cidade', $user->cidade ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="estado" id="estado" maxlength="2"
                                   value="<?php echo e(old('estado', $user->estado ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                                   placeholder="Ex: SP">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="urgencia_nome_contato" id="urgencia_nome_contato" 
                                   value="<?php echo e(old('urgencia_nome_contato', $user->urgencia_nome_contato ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="urgencia_telefone_contato" id="urgencia_telefone_contato" 
                                   value="<?php echo e(old('urgencia_telefone_contato', $user->urgencia_telefone_contato ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <?php if($isEdit && $user->documento_rg): ?>
                        ...
                        <div>
                            ...
                            <input type="file" name="documento_cnh" id="documento_cnh" 
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            <p class="text-xs text-gray-500 mt-1">PDF, JPG, JPEG ou PNG. Máximo 2MB.</p>
                            <?php if($isEdit && $user->documento_cnh): ?>
                                <p class="text-xs text-green-600 mt-1">✅ Documento enviado</p>
                            <?php endif; ?>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" name="documento_cpf" id="documento_cpf" 
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            <p class="text-xs text-gray-500 mt-1">PDF, JPG, JPEG ou PNG. Máximo 2MB.</p>
                            <?php if($isEdit && $user->documento_cpf): ?>
                                <p class="text-xs text-green-600 mt-1">✅ Documento enviado</p>
                            <?php endif; ?>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" name="documento_foto_3x4" id="documento_foto_3x4" 
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            <p class="text-xs text-gray-500 mt-1">JPG, JPEG ou PNG. Máximo 2MB.</p>
                            <?php if($isEdit && $user->documento_foto_3x4): ?>
                                <p class="text-xs text-green-600 mt-1">✅ Documento enviado</p>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div>
                            <div class="flex items-center mb-3">
                                ...
                                <input type="checkbox" name="tem_deficiencia" id="tem_deficiencia" value="1" 
                                       <?php echo e(old('tem_deficiencia', $user->tem_deficiencia ?? false) ? 'checked' : ''); ?>

                                       class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                <label for="tem_deficiencia" class="ml-2 block text-sm font-medium text-gray-900">Possui alguma deficiência</label>
                            </div>
                            <div id="descricao_deficiencia_container" style="display: <?php echo e(old('tem_deficiencia', $user->tem_deficiencia ?? false) ? 'block' : 'none'); ?>;">
                                ...
                                <textarea name="descricao_deficiencia" id="descricao_deficiencia" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('descricao_deficiencia', $user->descricao_deficiencia ?? '')); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center mb-3">
                                ...
                                <input type="checkbox" name="tem_condicao_saude" id="tem_condicao_saude" value="1" 
                                       <?php echo e(old('tem_condicao_saude', $user->tem_condicao_saude ?? false) ? 'checked' : ''); ?>

                                       class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                <label for="tem_condicao_saude" class="ml-2 block text-sm font-medium text-gray-900">Possui condição de saúde especial</label>
                            </div>
                            <div id="descricao_saude_container" style="display: <?php echo e(old('tem_condicao_saude', $user->tem_condicao_saude ?? false) ? 'block' : 'none'); ?>;">
                                ...
                                <textarea name="descricao_saude" id="descricao_saude" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('descricao_saude', $user->descricao_saude ?? '')); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center mb-3">
                                ...
                                <input type="checkbox" name="tem_alergia" id="tem_alergia" value="1" 
                                       <?php echo e(old('tem_alergia', $user->tem_alergia ?? false) ? 'checked' : ''); ?>

                                       class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                <label for="tem_alergia" class="ml-2 block text-sm font-medium text-gray-900">Possui alguma alergia</label>
                            </div>
                            <div id="descricao_alergia_container" style="display: <?php echo e(old('tem_alergia', $user->tem_alergia ?? false) ? 'block' : 'none'); ?>;">
                                ...
                                <textarea name="descricao_alergia" id="descricao_alergia" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('descricao_alergia', $user->descricao_alergia ?? '')); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center mb-3">
                                ...
                                <input type="checkbox" name="usa_medicamento" id="usa_medicamento" value="1" 
                                       <?php echo e(old('usa_medicamento', $user->usa_medicamento ?? false) ? 'checked' : ''); ?>

                                       class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                <label for="usa_medicamento" class="ml-2 block text-sm font-medium text-gray-900">Usa medicamento contínuo</label>
                            </div>
                            <div id="qual_medicamento_container" style="display: <?php echo e(old('usa_medicamento', $user->usa_medicamento ?? false) ? 'block' : 'none'); ?>;">
                                ...
                                <textarea name="qual_medicamento" id="qual_medicamento" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('qual_medicamento', $user->qual_medicamento ?? '')); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="ensino_pre_escolar" id="ensino_pre_escolar" value="1" 
                                   <?php echo e(old('ensino_pre_escolar', $user->ensino_pre_escolar ?? false) ? 'checked' : ''); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_fundamental_status" id="ensino_fundamental_nao" value="nao" 
                                           <?php echo e((!old('ensino_fundamental_concluido', $user->ensino_fundamental_concluido ?? false) && !old('ensino_fundamental_cursando', $user->ensino_fundamental_cursando ?? false)) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_fundamental_status" id="ensino_fundamental_cursando" value="cursando" 
                                           <?php echo e(old('ensino_fundamental_cursando', $user->ensino_fundamental_cursando ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_fundamental_status" id="ensino_fundamental_concluido" value="concluido" 
                                           <?php echo e(old('ensino_fundamental_concluido', $user->ensino_fundamental_concluido ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="ensino_fundamental_instituicao" id="ensino_fundamental_instituicao" 
                                           value="<?php echo e(old('ensino_fundamental_instituicao', $user->ensino_fundamental_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_medio_status" id="ensino_medio_nao" value="nao" 
                                           <?php echo e((!old('ensino_medio_concluido', $user->ensino_medio_concluido ?? false) && !old('ensino_medio_cursando', $user->ensino_medio_cursando ?? false)) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_medio_status" id="ensino_medio_cursando" value="cursando" 
                                           <?php echo e(old('ensino_medio_cursando', $user->ensino_medio_cursando ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_medio_status" id="ensino_medio_concluido" value="concluido" 
                                           <?php echo e(old('ensino_medio_concluido', $user->ensino_medio_concluido ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="ensino_medio_instituicao" id="ensino_medio_instituicao" 
                                           value="<?php echo e(old('ensino_medio_instituicao', $user->ensino_medio_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_tecnico_status" id="ensino_tecnico_nao" value="nao" 
                                           <?php echo e((!old('ensino_tecnico_concluido', $user->ensino_tecnico_concluido ?? false) && !old('ensino_tecnico_cursando', $user->ensino_tecnico_cursando ?? false)) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_tecnico_status" id="ensino_tecnico_cursando" value="cursando" 
                                           <?php echo e(old('ensino_tecnico_cursando', $user->ensino_tecnico_cursando ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_tecnico_status" id="ensino_tecnico_concluido" value="concluido" 
                                           <?php echo e(old('ensino_tecnico_concluido', $user->ensino_tecnico_concluido ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="ensino_tecnico_instituicao" id="ensino_tecnico_instituicao" 
                                           value="<?php echo e(old('ensino_tecnico_instituicao', $user->ensino_tecnico_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_superior_status" id="ensino_superior_nao" value="nao" 
                                           <?php echo e((!old('ensino_superior_concluido', $user->ensino_superior_concluido ?? false) && !old('superior_cursando', $user->superior_cursando ?? false) && !old('superior_trancado', $user->superior_trancado ?? false)) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_superior_status" id="superior_cursando" value="cursando" 
                                           <?php echo e(old('superior_cursando', $user->superior_cursando ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_superior_status" id="superior_trancado" value="trancado" 
                                           <?php echo e(old('superior_trancado', $user->superior_trancado ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="ensino_superior_status" id="ensino_superior_concluido" value="concluido" 
                                           <?php echo e(old('ensino_superior_concluido', $user->ensino_superior_concluido ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="md:col-span-4">
                                    ...
                                    <input type="text" name="superior_instituicao" id="superior_instituicao" 
                                           value="<?php echo e(old('superior_instituicao', $user->superior_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="flex items-center">
                                    <input type="radio" name="pos_graduacao_status" id="pos_graduacao_nao" value="nao" 
                                           <?php echo e((!old('pos_graduacao_concluido', $user->pos_graduacao_concluido ?? false) && !old('pos_graduacao_cursando', $user->pos_graduacao_cursando ?? false)) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="pos_graduacao_status" id="pos_graduacao_cursando" value="cursando" 
                                           <?php echo e(old('pos_graduacao_cursando', $user->pos_graduacao_cursando ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="pos_graduacao_status" id="pos_graduacao_concluido" value="concluido" 
                                           <?php echo e(old('pos_graduacao_concluido', $user->pos_graduacao_concluido ?? false) ? 'checked' : ''); ?>
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="pos_graduacao_instituicao" id="pos_graduacao_instituicao" 
                                           value="<?php echo e(old('pos_graduacao_instituicao', $user->pos_graduacao_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="curso_1" id="curso_1" 
                                           value="<?php echo e(old('curso_1', $user->curso_1 ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="curso_1_instituicao" id="curso_1_instituicao" 
                                           value="<?php echo e(old('curso_1_instituicao', $user->curso_1_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="curso_2" id="curso_2" 
                                           value="<?php echo e(old('curso_2', $user->curso_2 ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="curso_2_instituicao" id="curso_2_instituicao" 
                                           value="<?php echo e(old('curso_2_instituicao', $user->curso_2_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="curso_3" id="curso_3" 
                                           value="<?php echo e(old('curso_3', $user->curso_3 ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="curso_3_instituicao" id="curso_3_instituicao" 
                                           value="<?php echo e(old('curso_3_instituicao', $user->curso_3_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="situacao_profissional" id="situacao_profissional" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="">Selecione...</option>
                                <option value="empregado" <?php echo e(old('situacao_profissional', $user->situacao_profissional ?? '') == 'empregado' ? 'selected' : ''); ?>>Empregado</option>
                                <option value="desempregado" <?php echo e(old('situacao_profissional', $user->situacao_profissional ?? '') == 'desempregado' ? 'selected' : ''); ?>>Desempregado</option>
                                <option value="autonomo" <?php echo e(old('situacao_profissional', $user->situacao_profissional ?? '') == 'autonomo' ? 'selected' : ''); ?>>Autônomo</option>
                                <option value="estudante" <?php echo e(old('situacao_profissional', $user->situacao_profissional ?? '') == 'estudante' ? 'selected' : ''); ?>>Estudante</option>
                                <option value="aposentado" <?php echo e(old('situacao_profissional', $user->situacao_profissional ?? '') == 'aposentado' ? 'selected' : ''); ?>>Aposentado</option>
                            </select>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="experiencia_1_instituicao" id="experiencia_1_instituicao" 
                                           value="<?php echo e(old('experiencia_1_instituicao', $user->experiencia_1_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="experiencia_1_ano" id="experiencia_1_ano" 
                                           value="<?php echo e(old('experiencia_1_ano', $user->experiencia_1_ano ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="experiencia_1_funcao" id="experiencia_1_funcao" 
                                           value="<?php echo e(old('experiencia_1_funcao', $user->experiencia_1_funcao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <textarea name="experiencia_1_atividades" id="experiencia_1_atividades" rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('experiencia_1_atividades', $user->experiencia_1_atividades ?? '')); ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="experiencia_2_instituicao" id="experiencia_2_instituicao" 
                                           value="<?php echo e(old('experiencia_2_instituicao', $user->experiencia_2_instituicao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="experiencia_2_ano" id="experiencia_2_ano" 
                                           value="<?php echo e(old('experiencia_2_ano', $user->experiencia_2_ano ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="experiencia_2_funcao" id="experiencia_2_funcao" 
                                           value="<?php echo e(old('experiencia_2_funcao', $user->experiencia_2_funcao ?? '')); ?>" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <textarea name="experiencia_2_atividades" id="experiencia_2_atividades" rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('experiencia_2_atividades', $user->experiencia_2_atividades ?? '')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="nivel_ingles" id="nivel_ingles" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="">Selecione...</option>
                                <option value="basico" <?php echo e(old('nivel_ingles', $user->nivel_ingles ?? '') == 'basico' ? 'selected' : ''); ?>>Básico</option>
                                <option value="avancado" <?php echo e(old('nivel_ingles', $user->nivel_ingles ?? '') == 'avancado' ? 'selected' : ''); ?>>Avançado</option>
                                <option value="fluente" <?php echo e(old('nivel_ingles', $user->nivel_ingles ?? '') == 'fluente' ? 'selected' : ''); ?>>Fluente</option>
                            </select>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="desenvolveu_sistemas" id="desenvolveu_sistemas" value="1" 
                                       <?php echo e(old('desenvolveu_sistemas', $user->desenvolveu_sistemas ?? false) ? 'checked' : ''); ?>
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="ja_empreendeu" id="ja_empreendeu" value="1" 
                                       <?php echo e(old('ja_empreendeu', $user->ja_empreendeu ?? false) ? 'checked' : ''); ?>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                ...
                                <?php $__currentLoopData = $diasSemana; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center">
                                        <input type="checkbox" name="disponibilidade_dias[]" id="dia_<?php echo e($dia); ?>" value="<?php echo e($dia); ?>" 
                                               <?php echo e(in_array($dia, $diasSelecionados) ? 'checked' : ''); ?>

                                               class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                        <label for="dia_<?php echo e($dia); ?>" class="ml-2 block text-sm text-gray-900"><?php echo e($diasLabels[$index]); ?></label>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="disponibilidade_horario" id="disponibilidade_horario" 
                                   value="<?php echo e(old('disponibilidade_horario', $user->disponibilidade_horario ?? '')); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" 
                        ...
                        <span><?php echo e($isEdit ? '💾 Atualizar' : '➕ Criar'); ?></span>
                        <span>Usuário</span>
                    </button>
                </div>
            </form>
...
</script><?php /**PATH C:\Users\villa\Desktop\laragon\www\sisInscricao\resources\views/auth/register-extended.blade.php ENDPATH**/ ?>